...
/**
 * @file
 * Contains \Drupal\advagg\Form\SettingsForm.
 */
...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['global']['obscure']['path_convert_absolute_to_relative'] = [
      '#type' => 'checkbox',
      '#title' => t('Convert absolute paths to be self references.'),
      '#default_value' => $config->get('path.convert.absolute_to_relative'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('advagg.settings')
      ...
      ->set('path.convert.absolute_to_relative', $form_state->getValue('path_convert_absolute_to_relative'))
